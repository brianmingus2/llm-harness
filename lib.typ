...
#let resume(
  ...
  let contacts = {
    ...
    if ("linkedin" in author and str(author.linkedin) != "") {
    ...
    if ("github" in author and str(author.github) != "") {
      ...
      secondary.push[
        #contact-item(github-icon, "https://github.com/" + author.github, label)
      ]
    }
...
#let resume-item(body) = {
  ...
  set list(
    // Softer, smaller bullet marker.
    marker: text(size: default-body-size * 0.75, weight: "regular", fill: color-gray)[#sym.bullet],
  )
  block(above: 0em)[
    #body
  ]
